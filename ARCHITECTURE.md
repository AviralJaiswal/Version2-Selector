# 📐 Qcom Data Shopper — Technical System Architecture

**Data Shopper** is an enterprise-grade broadband connected intelligence platform built with a React (Vite) frontend, FastAPI backend core, LLM tool orchestration, dual-geocoding fallback engine (Mapbox + OpenStreetMap), and vector-based RAG support.
