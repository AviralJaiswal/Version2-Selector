...
export function SavedCustomerCard({ custName, custPhone, custEmail, onSave, busy, readOnly, inline }) {
  ...
  if (isEditing) {
    const editCardStyle = inline
      ? { width: '100%', maxWidth: '100%', padding: '14px', marginTop: '10px', background: '#FFFFFF', border: '1.5px solid #E31B23', borderRadius: '12px', boxShadow: '0 3px 10px rgba(227, 27, 35, 0.1), inset 0 1px 0 rgba(255,255,255,0.6)', boxSizing: 'border-box' }
      : { width: '540px', maxWidth: '100%', padding: '16px', background: '#FFFFFF', border: '2px solid #E31B23', borderRadius: '14px', boxShadow: '0 4px 14px rgba(227, 27, 35, 0.12)', boxSizing: 'border-box' }
    const cardBody = (
      <div className="message-content customer-card-content" style={editCardStyle}>
  ...
  const viewCardStyle = inline
    ? { width: '100%', maxWidth: '100%', padding: '14px', marginTop: '10px', background: 'linear-gradient(135deg, #FFF5F5 0%, #FFFFFF 100%)', border: '1.5px solid #E31B23', borderRadius: '12px', boxShadow: '0 3px 10px rgba(227, 27, 35, 0.1), inset 0 1px 0 rgba(255,255,255,0.6)', boxSizing: 'border-box' }
    : { width: '540px', maxWidth: '100%', padding: '16px', background: 'linear-gradient(135deg, #FFF5F5 0%, #FFFFFF 100%)', border: '2px solid #E31B23', borderRadius: '14px', boxShadow: '0 4px 12px rgba(227, 27, 35, 0.08)', boxSizing: 'border-box' }

  const viewCardBody = (
      <div className="message-content customer-card-content" style={viewCardStyle}>
