...
async def lifespan(app_instance: FastAPI):
    ...
    try:
        ...
        from app.rag.chroma_rag import init_faq_chroma, init_existing_customer_chroma
        init_faq_chroma()
...
app = FastAPI(
    ...
    version="1.0.0",
    description="Data Shopper Modular FastAPI Backend - Step-by-Step Execution Flow & RAG AI Assistant",
    lifespan=lifespan
)
...
# 1. Welcome / Session (Data Shopper Session API) -> POST /api/v1/session
...
def root_status() -> dict:
    ...
    return {
        "status": "online",
        "message": "Data Shopper API is running"
    }
