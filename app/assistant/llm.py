        ...
        if final_match and final_match.group(1).strip():
            ...
            for line in lines:
                ...
                if in_thinking:
                    ...
                    if re.match(r"^(?:Hello|Hi|Welcome|Sure|Great|Thank you|Dear|Namaste|Data Shopper|\*|I can help|We offer|Good day)", l_strip, flags=re.IGNORECASE) and not re.search(r"Draft|Word count|Attempt|Analyze|Identify", l_strip, flags=re.IGNORECASE):
                        in_thinking = False
