    ...
    <main className="landing-view">
      <section className="landing-copy">
        ...
        <h1 className="glitter-heading">
          <GlitterLetterText text="Data Shopper" className="title-main" />
          <br />
      ...
      <section className="entry-card">
        <div className="entry-head">
          ...
          <div>
            <strong>Welcome to Data Shopper</strong>
        ...
        <div className="entry-options">
          ...
          <button onClick={() => setView('existing')} className="entry-btn red-hover prodapt-click-btn">
            <span className="entry-icon red-icon"><UsersGroupIcon size={24} /></span>
            <span>
