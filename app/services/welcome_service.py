...
_DYNAMIC_GREETINGS = {
    "existing": [
        "Welcome back to Data Shopper. Please share your registered 10-digit mobile number so I can verify your connection.",
        "Hello again! To pull up your Data Shopper connection, could you share the registered contact number on the account?",
    ...
    "general": [
        "Welcome to Data Shopper! I am your AI broadband assistant. How can I help you today? You can explore our high-speed fiber plans, check installation timelines, or inquire about Wi-Fi 6 router features.",
        "Hello and welcome to Data Shopper! Looking for ultra-fast fiber internet? Ask me about our unlimited broadband plans (40 Mbps to 1 Gbps), bundled OTT streaming benefits, or check coverage in your area.",
        "Hi there! Welcome to Data Shopper broadband support. I'm here to help you compare high-speed internet plans, learn about our zero-fee installation offers, or find the ideal plan for your home or workspace.",
        "Welcome to Data Shopper! Ready to experience lightning-fast fiber broadband? Let me know what you need—whether it's plan recommendations, 4K streaming benefits, or checking service availability.",
        "Greetings! I am Data Shopper's broadband guide. How can I assist you today with fiber optic internet plans, router specifications, or installation details?",
    ],
}
...
def generate_dynamic_greeting(profile: str = "general") -> str:
    ...
    chosen_style = random.choice(styles) if styles else "Greet the user warmly as Data Shopper's broadband AI assistant."
